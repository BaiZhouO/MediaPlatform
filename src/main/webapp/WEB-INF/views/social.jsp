    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="homepage.html" class="active"><font size="3">首页</font></a></li>
                <li><a href="dataTotal.html"><font size="3">数据分析</font></a></li>
                <li><a href="viewPersonInfo.html"><font size="3">我的信息</font></a></li>
                <li><a href="social.html"><font size="3">留言社区</font></a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="tab-content">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-7 col-md-offset-2 main">
            <h2 >通知列表</h2>
                <h3><a href="publishMsg.html"><span class="label label-primary">发布通知</span></a></h3>
                    </br></br>

                    <div class="grid_3 grid_4 ">
                        <h3 class="hdg"><a href="msgDetail.html">通知标题1</a></h3>
                    ...
                    <div class="grid_3 grid_4 ">
                        <h3> class="hdg"><a href="msgDetail.html">通知标题2</a></h3>
                        <div class="bs-example">
                            <table class="table">
                                <tbody>
                                <tr><h4>简略内容</h4></tr>
